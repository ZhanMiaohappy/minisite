...
(function() {
    ...
    VideoListController.$inject = ['VideoGetAll', 'VideoGetAllByTag','toaster', 'pagingParams', '$state'];

    function VideoListController (VideoGetAll,VideoGetAllByTag, toaster, pagingParams, $state) {
        var vm = this;
        ...
        VideoGetAll.query({page: vm.page - 1, size:20, sort: 'asc'}, {}, function onSuccess(response) {
        ...
        function selectVideoTag(num) {
            ...
            VideoGetAllByTag.query({page: vm.page - 1, size: 20, sort: 'asc',id: num},{},function onSuccess(response) {
                // console.log(response);
                vm.videoAll = response.content;
                vm.isFirst = response.first;
                vm.isLast = response.last;

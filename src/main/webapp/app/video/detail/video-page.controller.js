...
(function () {
    ...
    VideoPageController.$inject = ['YoukuUtils', '$stateParams', 'GetVideoById', 'VideoGetAllCommentByLevel'];

    function VideoPageController(YoukuUtils, $stateParams, GetVideoById, VideoGetAllCommentByLevel) {
        var vm = this;

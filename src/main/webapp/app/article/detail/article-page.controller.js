(function () {
    ...
    ArticlePageController.$inject = ['$state', 'GetArticleById', 'NewsGetAllComment', '$stateParams','Principal','RegisterService'];

    function ArticlePageController($state, GetArticleById, NewsGetAllComment, $stateParams,Principal,RegisterService) {
        var vm = this;

...
(function() {
    ...
    DashboardMarkUserController.$inject = ['toaster', 'GetHomePage', 'UpdateHomePageArticle'];

    function DashboardMarkUserController(toaster, GetHomePage, UpdateHomePageArticle) {
        var vm = this;

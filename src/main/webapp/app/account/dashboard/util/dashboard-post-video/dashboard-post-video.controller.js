...
(function () {
    ...
    DashboardPostVideoController.$inject = ['YoukuUtils', 'AvatarUploadService', 'CreateVideo', 'EditVideo', 'toaster'];

    function DashboardPostVideoController(YoukuUtils, AvatarUploadService, CreateVideo, EditVideo, toaster) {
        ...
        function Upload() {
            ...
            AvatarUploadService.open("ArticleImage", {aspectRatio:262/170,compress:true, width:262},
                function (result) {
                    if(result){

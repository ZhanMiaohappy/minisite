(function () {
    ...
    RegisterController.$inject = ['$rootScope', '$translate', '$timeout', '$interval', 'Auth', '$state',
        ...
        'ResetRequest', 'RegisterService', 'resetSmsCodeSend'];
    ...
    function RegisterController($rootScope, $translate, $timeout, $interval, Auth, $state,
        ...
        function requestReset () {
            ...
            vm.codeError = null;
            vm.sendSuccess = null;
            if (vm.resetAccount.newPassword !== vm.confirmResetPassword) {
                vm.doNotMatch = 'ERROR';
            } else {
                vm.doNotMatch = null;
                vm.error = null;

...
public class TeamPlayer implements Serializable {
    ...
    public static TeamPlayer createTeamPlayer(Team t, TeamPlayer data){
        TeamPlayer tP = new TeamPlayer();
        tP.setTeam(t);
        tP.setState("member");
        tP.setName(data.getName());
        tP.setPersonalId(data.getPersonalId());
        tP.setPhone(data.getPhone());
        tP.setSchoolId(data.getSchoolId());
        tP.setMiID(data.getMiID());
        return tP;
    }

    public void editTeamPlayer(TeamPlayer data){
        this.name = data.getName();
        this.personalId = data.getPersonalId();
        this.phone = data.getPhone();
        this.schoolId = data.getSchoolId();
        this.miID = data.getMiID();
    }

    public void editCaptain(String name, String personalId, String phone, String schoolId, String miID){
        this.name = name;
        this.personalId = personalId;
        this.phone = phone;
        this.schoolId = schoolId;
    ...
    public static TeamPlayer create(Team t, User p){
        TeamPlayer tP = new TeamPlayer();
        tP.setTeam(t);
        tP.setState("captain");
        tP.setName(p.getFirstName());
        tP.setPersonalId(p.getPersonalID());
        tP.setPhone(p.getPhone());
        tP.setSchoolId(p.getSchoolID());
        tP.setMiID(p.getMiID());
        return tP;
    }

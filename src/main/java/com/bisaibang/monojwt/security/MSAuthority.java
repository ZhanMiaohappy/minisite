...
import com.bisaibang.monojwt.domain.vm.*;
...
public class MSAuthority {
    ...
    public HomeConfig homeConfigSQLInject(HomeConfig homeConfig) {
        ...
        homeConfig.setBattleConfig(StringEscapeUtils.escapeSql(homeConfig.getBattleConfig()));
        return homeConfig;
    }
    ...
    public PictureVM SQLInject(PictureVM pictureVM) {
        pictureVM.setTag(StringEscapeUtils.escapeSql(pictureVM.getTag()));
        pictureVM.setUrl(StringEscapeUtils.escapeSql(pictureVM.getUrl()));
        return pictureVM;
    }

    public RegistVM registSQLInject(RegistVM data) {
        data.setName(StringEscapeUtils.escapeSql(data.getName()));
        data.setPersonID(StringEscapeUtils.escapeSql(data.getPersonID()));
        data.setPhone(StringEscapeUtils.escapeSql((data.getPhone())));
        data.setSchool(StringEscapeUtils.escapeSql(data.getSchool()));
        data.setSchoolID(StringEscapeUtils.escapeSql(data.getSchoolID()));
        data.setTeamName(StringEscapeUtils.escapeSql(data.getTeamName()));
        data.setMiID(StringEscapeUtils.escapeSql(data.getMiID()));
        return data;
    }
}
